...
rs1 = Neural_Network(0.1)
rs2 = Neural_Network(0.2)
rs3 = Neural_Network(0.3)
rs4 = Neural_Network(0.4)
rs5 = Neural_Network(0.5)

print('For learning rate:',0.1,'\n the satisfied epoch is:',rs1)
print('For learning rate:',0.2,'\n the satisfied epoch is:',rs2)
print('For learning rate:',0.3,'\n the satisfied epoch is:',rs3)
print('For learning rate:',0.4,'\n the satisfied epoch is:',rs4)
print('For learning rate:',0.5,'\n the satisfied epoch is:',rs5)